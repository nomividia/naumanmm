...
exports.ReviewRequestEmailTemplates = void 0;
class ReviewRequestEmailTemplates {
    static getFrenchTemplate(candidateFirstName, googleReviewUrl) {
        return {
            subject: "Votre retour d'expérience suite à votre entretien chez Morgan & Mallet",
...
L'équipe Morgan & Mallet International`,
    ...
    static getEnglishTemplate(candidateFirstName, googleReviewUrl) {
        return {
            subject: 'Your feedback following your interview at Morgan & Mallet',
...
exports.ReviewRequestEmailTemplates = ReviewRequestEmailTemplates;
//# sourceMappingURL=review-request-email-templates.js.map