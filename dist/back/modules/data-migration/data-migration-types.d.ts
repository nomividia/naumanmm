...
export interface JA_Candidate_Attachment {
    AttachmentID: number;
    ContactID: number;
    Type: 'FormattedResume' | 'Other' | 'Resume' | 'License' | 'CoverLetter' | 'Reference' | 'Check' | 'Screening';
    FileName: string;
    FileType: string;
    FileSize: number;
}
...
export declare class DataMigrationResponse extends GenericResponse {
    successList: number[];
    errorsList: number[];
    ignoredList: number[];
...
export declare class DataMigrationCandidateApplicationResponse extends GenericResponse {
    successList: string[];
    successListCount: number;
    linesPerFile: {
        fileName: string;
        lines: number;
    }[];
    ...
    bytesIgnored: number;
    bytesAdded: number;
    get megaBytesAdded(): number;
    get megaBytesIgnored(): number;
    private getMegaBytes;
}
