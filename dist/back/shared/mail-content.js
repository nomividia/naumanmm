...
class MailContent {
    static getMailContentAndSubject(mailType, addMailFooter = true, lang, countryCode, injectValues, jobOfferData) {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        lang = candidates_helpers_1.SharedCandidatesHelpers.getDefaultLanguage(lang, countryCode);
        let mailContent = '';
        let mailSubject = '';
        mailContent = (_d = (_c = (_b = (_a = this.mailContentData) === null || _a === void 0 ? void 0 : _a.find((x) => x.mailType === mailType)) === null || _b === void 0 ? void 0 : _b.langs) === null || _c === void 0 ? void 0 : _c.find((x) => x.langCode === lang)) === null || _d === void 0 ? void 0 : _d.content;
        mailSubject = (_h = (_g = (_f = (_e = this.mailContentData) === null || _e === void 0 ? void 0 : _e.find((x) => x.mailType === mailType)) === null || _f === void 0 ? void 0 : _f.langs) === null || _g === void 0 ? void 0 : _g.find((x) => x.langCode === lang)) === null || _h === void 0 ? void 0 : _h.subject;
        if (!mailContent)
            mailContent = '';
        if (injectValues === null || injectValues === void 0 ? void 0 : injectValues.length) {
            for (let index = 0; index < injectValues.length; index++) {
                const str = injectValues[index];
                mailContent = nextalys_js_helpers_1.MainHelpers.replaceAll(mailContent, '{' + (index + 1) + '}', str);
            }
        }
        const jobOfferInfoFr = this.formatJobOfferInfo(jobOfferData, 'fr');
        const jobOfferInfoEn = this.formatJobOfferInfo(jobOfferData, 'en');
        mailContent = nextalys_js_helpers_1.MainHelpers.replaceAll(mailContent, '{jobOfferInfoFr}', jobOfferInfoFr);
        mailContent = nextalys_js_helpers_1.MainHelpers.replaceAll(mailContent, '{jobOfferInfoEn}', jobOfferInfoEn);
        const jobOfferInfo = this.formatJobOfferInfo(jobOfferData, lang);
        mailContent = nextalys_js_helpers_1.MainHelpers.replaceAll(mailContent, '{jobOfferInfo}', jobOfferInfo);
        if (addMailFooter) {
            mailContent += `
    ...
    static formatJobOfferInfo(jobOfferData, lang) {
        if (!(jobOfferData === null || jobOfferData === void 0 ? void 0 : jobOfferData.ref) && !(jobOfferData === null || jobOfferData === void 0 ? void 0 : jobOfferData.title)) {
            return lang === 'fr'
...
Job offer details : <a href="{1}">{1}</a>`,
    ...
    },
    {
        ...
        langs: [
            {
                langCode: 'fr',
                subject: '🇫🇷 Votre candidature Morgan & Mallet International / 🇬🇧 Your Morgan & Mallet International job application',
