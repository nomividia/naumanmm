...
exports.migrationCurrentJobs1656320354087 = void 0;
class migrationCurrentJobs1656320354087 {
    constructor() {
        this.name = 'migrationCurrentJobs1656320354087';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE \`candidate-current-jobs\` CHANGE \`currentJobId\` \`currentJobId\` varchar(36) NOT NULL`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            yield queryRunner.query(`ALTER TABLE \`candidate-current-jobs\` DROP FOREIGN KEY \`FK_d3f86ed0cd3ef06c21b2f47bb94\``);
            yield queryRunner.query(`ALTER TABLE \`candidate-current-jobs\` DROP FOREIGN KEY \`FK_bada2f86ae56a99fd741c49d905\``);
            yield queryRunner.query(`ALTER TABLE \`candidate-current-jobs\` CHANGE \`currentJobId\` \`currentJobId\` varchar(36) NULL`);
...
exports.migrationCurrentJobs1656320354087 = migrationCurrentJobs1656320354087;
//# sourceMappingURL=1656320354087-migration-current-jobs.js.map