...
export class includeCandidateApplications1668766347436 implements MigrationInterface {
    name = 'includeCandidateApplications1668766347436'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`newsletter\` ADD \`includeCandidateApplication\` tinyint NULL DEFAULT '0'`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`newsletter\` DROP COLUMN \`includeCandidateApplication\``);
