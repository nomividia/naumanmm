...
export class candidateApplicationsCount1668771111891 implements MigrationInterface {
    name = 'candidateApplicationsCount1668771111891'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`newsletter\` ADD \`candidateApplicationsCount\` int NULL DEFAULT '0'`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`newsletter\` DROP COLUMN \`candidateApplicationsCount\``);
