...
export class newsletterUnsubscribedGuid1666254639162 implements MigrationInterface {
    name = 'newsletterUnsubscribedGuid1666254639162'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`candidates\` ADD \`newsletterUnsubscribedGuid\` varchar(36) NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        // await queryRunner.query(`ALTER TABLE \`roles_rights\` DROP FOREIGN KEY \`FK_4e206355419b43fe51eb9aade07\``);
        // await queryRunner.query(`ALTER TABLE \`user_roles\` DROP FOREIGN KEY \`FK_13380e7efec83468d73fc37938e\``);
        await queryRunner.query(`ALTER TABLE \`candidates\` DROP COLUMN \`newsletterUnsubscribedGuid\``);
