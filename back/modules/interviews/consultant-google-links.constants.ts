...
export const CONSULTANT_GOOGLE_LINK_MAPPINGS: ConsultantGoogleLinkMapping[] = [
    {
        consultantIds: [
    ...
    {
        consultantIds: ['1f63d14f-af11-48be-a52d-29b07df4b9db'], // Cara
    ...
    },
    {
        ...
        ], // Dave, Arnie, Ellie, Raniel
        googleReviewUrl: 'https://g.page/r/CdOuW09tHQ3iEBM/review',
        agencyLocation: 'Dubai',
    },
];

// Special case for Swiss residents - this will be determined by candidate location, not consultant
export const SWISS_GOOGLE_REVIEW_URL =
    'https://g.page/r/CdSu6ip-awYXEBM/review';

export class ConsultantGoogleLinkHelper {
    /**
     * Get Google review URL based on consultant ID
     */
    static getGoogleReviewUrlByConsultant(consultantId: string): string | null {
        const foundMapping = CONSULTANT_GOOGLE_LINK_MAPPINGS.find((mapping) =>
            mapping.consultantIds.some((id) => id === consultantId),
        );
